...
class AlienInvasion:
    ...
    def _update_aliens(self):
        """ Check if the fleet is at an edge, then update the position. """
        self._check_fleet_endges()
        self.aliens.update()
    ...
    def _ship_hit(self):
        ...
        if self.stats.ship_left > 0:
            ...
            # Get rid of any remaining bu`llets and aliens.
            self.bullets.empty()
            self.aliens.empty()

            # Create a new fleet and center a ship
            self._create_fleet()
